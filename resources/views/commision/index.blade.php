                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header header-elements-inline">
                                        <h6 class="card-title">{{ (isset($data)? 'Update Commission':'Add Commission') }}</h6>
                                    ...
                                    @if(isset($data))
                                        <div class="card-body">
                                            {{ Form::model($data,['method'=>'put','route' => ['commission.update',$data->id]]) }}
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('commission','Commission in %age') }}<span style="color: red;">*</span>
                                                        {{ Form::text('commission',$data->value,array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Commission %age')) }}
                                                        {!! $errors->first('commission', '*<label id="commission-error" class="error" for="commission">:message</label>') !!}
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @else
                                        <div class="card-body">
                                            {{ Form::open(['route' => 'commission.store']) }}
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('commission','Commission in %age') }}<span style="color: red;">*</span>
                                                        {{ Form::text('commission',old('commission'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Commission %age')) }}
                                                        {!! $errors->first('commission', '*<label id="commission-error" class="error" for="commission">:message</label>') !!}
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header header-elements-inline">
                                        <h6 class="card-title">Your Commission/ Cut is</h6>
                                        <div class="header-elements">
                                            <div class="list-icons">
                                                <a class="list-icons-item" data-action="collapse"></a>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <center>
                                                <h1 class="display-3">{{ \App\Setting::where('key','commission')->first()->value }}%</h1>
                                            </center>
                                        </div>
                                </div>
                            </div>
